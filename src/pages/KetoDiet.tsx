...
const KetoDiet = () => {
  ...
  const [completedChapters, setCompletedChapters] = useState<number[]>(savedProgress.nutrition.keto.completedChapters);
  const [unlockedChapters, setUnlockedChapters] = useState<number[]>(() => {
    const completed = savedProgress.nutrition.keto.completedChapters;
